unit
class LocalTProcedure
    inherit TProcedure in "%oot/tcel/TProcedure.tu"
    import Opcodes in "%oot/tcel/Opcodes.tu",
        OpcodeHelper in "%oot/tcel/internal/util/OpcodeHelper.tu",
        Primitives in "%oot/tcel/Primitives.tu",
        ReflectionFactory in "util/ReflectionFactory.tu",
        MutableReturnValue in "%oot/tcel/invocation/MutableReturnValue.tu"
    export construct
    var context: unchecked ^ProcedureContext
    
    proc construct(procedureContext: unchecked ^ProcedureContext)
    ...
    body fcn getContext(): unchecked ^ProcedureContext
        result context
    end getContext
